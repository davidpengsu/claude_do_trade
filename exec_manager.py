...
class ExecManager:
    ...
    def _handle_open_position(self, trader, event_id, symbol, position_type, request_data):
        ...
        try:
            ...
            tp_price = request_data.get("tp_price", None)
            sl_price = request_data.get("sl_price", None)
            ...
            self.db_manager.log_trade({
                ...
                "takeProfit": tp_price,  # 웹훅에서 전달받은 값 사용
                "stopLoss": sl_price,    # 웹훅에서 전달받은 값 사용  
                "orderStatus": TRADE_STATUS_OPEN,
